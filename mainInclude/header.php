...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      <a href="index.php" class="navbar-brand">SkillSpace</a>
      <span class="navbar-text">Learn and Get Skills</span>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          <li class="nav-item custom-nav-item"><a href="#Contact" class="nav-link">Contact us</a></li>
        </ul>
      </div>
    </nav> <!-- End Navigation -->